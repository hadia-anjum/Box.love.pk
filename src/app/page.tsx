...
const COLLECTIONS = [
  {
    ...
    emoji: "🎬",
    themes: [
      { name: "Spider-Man", image: "/collections/spiderman.jpg" },
  ...
  },
  {
    ...
    themes: [
      ...
      { name: "Ferrari", image: "/collections/ferrari.jpg" },
      { name: "Bugatti", image: "/collections/bugatti.jpg" },
      { name: "Charles Leclerc / F1", image: "/collections/charles_leclerc.jpg" },
    ],
  },
  {
    id: "gaming",
    ...
    themes: [
      ...
      { name: "Minecraft", image: "/collections/minecraft.png" },
      ...
      <section id="reviews" className="py-12 sm:py-28 px-4 sm:px-6 max-w-6xl mx-auto z-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              name: "S******",
              text: "Silver ink top box handwriting order kiya tha Rashid Ali name ke sath. Quality bohot outclass thi and writing is extremely neat! Worth every rupee!",
              rating: 5,
              img: "/rev1.jpg",
            },
            {
              name: "A******",
              text: "Happy 2 Years ka inside hanging banner lagwaya tha anniversary surprise ke liye. Lights ke sath to bohot he pyara lag raha tha!",
              rating: 5,
              img: "/rev2.jpg",
            },
            {
              name: "F******",
              text: "Gold writing on top for Sameer Khan birthday box was so perfect and premium. Finishing is top class, thank you box.love.pk!",
              rating: 5,
              img: "/rev3.jpg",
            },
            {
              name: "Z******",
              text: "Box ke inside gold writing check karein, literally so beautiful! Deep feelings express krne k liye perfect box hai.",
              rating: 5,
              img: "/rev4.jpg",
            },
            {
              name: "M******",
              text: "Destiny quote for Ailla was written exactly as requested. Golden ink stands out so beautifully on the premium black velvet lid.",
              rating: 5,
              img: "/rev5.jpg",
            },
            {
              ...
              {COLLECTIONS.find(c => c.id === selectedCategory)?.themes.map((theme, i) => (
                ...
                >
                  {theme.image ? (
                    ...
                    <span className="text-4xl sm:text-5xl group-hover:scale-110 transition-transform mb-2">{'emoji' in theme ? (theme as any).emoji : '🎁'}</span>
                  )}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-[var(--pink-50)] via-white to-[var(--pink-100)] rounded-2xl p-6 text-center border border-pink-100/60">
                  {selectedTheme.image ? (
                    ...
                    <span className="text-6xl block mb-3">{'emoji' in selectedTheme ? (selectedTheme as any).emoji : '🎁'}</span>
                  )}
              ...
              <form onSubmit={handleCollectionCheckout} className="space-y-6">
                ...
                <div className="flex items-center gap-4 bg-pink-50/40 border border-pink-100 rounded-2xl p-4">
                  {selectedTheme.image ? (
                    ...
                    <span className="text-4xl">{'emoji' in selectedTheme ? (selectedTheme as any).emoji : '🎁'}</span>
                  )}
